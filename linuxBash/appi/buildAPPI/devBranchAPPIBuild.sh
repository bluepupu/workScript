...
EMAIL_PRJ_DIR="$ROOT_DIR/Email_branch_APPI"
...
function deployAPP(){
    ...
    local ANDROID_VERSION="6.0"
    local APK_VERSION="6.0010.01"
    ...
    local APK_OUT_DIR=$ANDROID_ABSOLUTE_DIR/out/target/product/FAO/system/app
    local TARGET_DIR=$ROOT_DIR/Release_APK/${APK_VERSION}
