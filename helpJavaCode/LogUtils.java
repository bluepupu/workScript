...
import java.util.Set; //MDY
import android.content.Intent; // MDY
import android.os.Bundle; //MDY
...
public class LogUtils {
    ...
    public static int logFeature(String featureName, String format,
        ...
        if (isLoggable(TAG, DEBUG)) {
            try {
                ...
                return Log.w(TAG, "[" + featureName + "] " + format + ": !!!! Log exception: ", e);
            }
    ...
    public static void dumpIntent(Intent i){
            ...
            if (bundle != null) {
                ...
                stringBuilder.append("-------------------------------------------------------------\n\r");
                Log.i(MY_TAG, stringBuilder.toString());
            }
    }
    //}MDY
